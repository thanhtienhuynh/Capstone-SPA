...
export * from './action-major-modal/action-major-modal.component';
export * from './delete-major-modal/delete-major-modal.component';
export * from './deactive-university-modal/deactive-university-modal.component';